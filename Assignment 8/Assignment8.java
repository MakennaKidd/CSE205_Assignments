                ...
                if (line.length() == 1)          //check if a user entered only one character
                {
                    switch (input1)
                    {
                        ...
                        case 'U':  //Write Text to a File
                            ...
                            //Code added to write a text string to the specified file. Catching exceptions.
                        ...
                        case 'V':  //Read Text from a File
                             ...
                             ************************************************************************************/
                            //Code added to read a text string from the specified file. Catching exceptions.
                            try
                            {
                                String sCurrentLine;
                                stdin = new BufferedReader(new FileReader(filename));
                                while ((sCurrentLine = stdin.readLine()) != null)
                                {
                        ...
                        case 'W':  //Serialize ClubManagement to a File
                             ...
                             ************************************************************************************/
                            //Code added to write the club management object to the specified file. Catching exceptions.
                            try
                            {
                                FileOutputStream fileOut = new FileOutputStream(filename);
                                ObjectOutputStream out = new ObjectOutputStream(fileOut);
                                out.writeObject(clubManage1);
                                out.close();
                                fileOut.close();
                        ...
                        case 'X':  //Deserialize ClubManagement from a File
                             ...
                             ***********************************************************************************/
                            //Code added to read a club management from the specified file. Catching exceptions.
                            try
                            {
                                FileInputStream fileIn = new FileInputStream(filename);
                                ObjectInputStream in = new ObjectInputStream(fileIn);
                                clubManage1 = (ClubManagement) in.readObject();
                                in.close();
                                fileIn.close();
                            } catch (IOException i)
                            {
                            ...
                            {
                                System.out.println("ClubManagement class not found");
                                c.printStackTrace();
                                return;
                            }
                            break;
